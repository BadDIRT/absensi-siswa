...
<head>
    ...
    <title>ABSENSIKU - Edit Kelas</title>
...
<div class="flex flex-1">
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="flex-1 flex flex-col transition-all duration-300">
            ...
            <!-- FORM -->
            <main class="p-2 sm:p-6 flex-1 mt-4 space-y-6">

                <div class="bg-white/10 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl 
                            p-6 sm:p-8 transition-all duration-500 hover:shadow-blue-500/30 hover:shadow-2xl hover:-translate-y-1 max-w-2xl mx-auto">
                    ...
                    <form method="POST" action="{{ route('classes.update', $class->id) }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            @error('grade')
                            <p class="mt-2 text-red-400 drop-shadow-[0_0_6px_rgba(255,0,0,0.8)] text-sm font-semibold">{{ $message }}</p>
                            @enderror
                        </div>
