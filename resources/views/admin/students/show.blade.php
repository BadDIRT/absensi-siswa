        ...
        <div class="flex-1 flex flex-col transition-all duration-300">
            ...
            <header class="sticky top-0 z-40 w-full bg-white/10 backdrop-blur-2xl border-b border-white/10 shadow-xl 
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-xl sm:text-2xl font-bold drop-shadow">Detail Siswa/i</h1>
                </div>
            </header>
            ...
            >
                ...
                <div class="bg-white/10 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl 
                            p-6 sm:p-8 transition-all duration-500 hover:shadow-blue-500/30">

                    <h2 class="text-lg sm:text-2xl font-bold mb-6">Informasi Siswa/i</h2>

                    <div class="grid sm:grid-cols-2 gap-6 text-white">

                        <div class="bg-white/5 p-4 rounded-2xl border border-white/10">
                            <p class="text-sm opacity-80">Nama Lengkap</p>
                            <p class="text-xl font-bold mt-1">{{ $student->name }}</p>
                        </div>
                        ...
                        <div class="bg-white/5 p-4 rounded-2xl border border-white/10">
                            <p class="text-sm opacity-80">Tanggal Lahir</p>
                            <p class="text-xl font-bold mt-1">
                        ...
                        <div class="bg-white/5 p-4 rounded-2xl border border-white/10">
                            <p class="text-sm opacity-80">NISN</p>
                            <p class="text-xl font-bold mt-1">{{ $student->nisn }}</p>
                        </div>

                        <div class="bg-white/5 p-4 rounded-2xl border border-white/10">
                            <p class="text-sm opacity-80">NIPD</p>
                            <p class="text-xl font-bold mt-1">{{ $student->nipd }}</p>
                        </div>

                        <div class="bg-white/5 p-4 rounded-2xl border border-white/10">
                            <p class="text-sm opacity-80">Kelas</p>
                            <p class="text-xl font-bold mt-1">{{ $student->class->grade ?? '-' }}</p>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 mt-8">
                        ...
                        <a href="{{ route('students.index') }}"
                            class="px-5 py-3 bg-white/20 hover:bg-white/30 border border-white/30 rounded-xl 
                                   font-semibold text-center backdrop-blur-xl transition duration-300 transform 
                                   hover:-translate-y-1 hover:shadow-lg hover:shadow-white/20">
                            Kembali
                        </a>

                        <a href="{{ route('students.edit', $student->id) }}"
                            class="px-5 py-3 bg-yellow-500/60 hover:bg-yellow-500/80 border border-white/20 rounded-xl 
                                   font-semibold backdrop-blur-xl text-center transition duration-300 transform 
                                   hover:-translate-y-1 hover:shadow-lg hover:shadow-yellow-500/30">
                            Edit
                        </a>

                        <button 
                            @click="confirmDelete = true"
                            class="px-5 py-3 bg-red-600/60 hover:bg-red-600/80 border border-white/20 rounded-xl 
                                   font-semibold backdrop-blur-xl w-full sm:w-auto transition duration-300 transform 
                                   hover:-translate-y-1 hover:shadow-lg hover:shadow-red-500/30">
                            Hapus
                        </button>
...
>
    <div x-transition.scale
        ...
        <h2 class="text-xl font-bold mb-4">Hapus Siswa?</h2>
