        ...
        <div class="flex-1 flex flex-col transition-all duration-300">
            ...
            <main class="p-2 sm:p-6 space-y-6 flex-1 mt-4">
                ...
                <div class="bg-white/10 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl p-6 sm:p-8 
                            transition-all duration-500 hover:shadow-blue-500/30 hover:shadow-2xl hover:-translate-y-1 max-w-2xl mx-auto">
                    ...
                    <form action="{{ route('departments.store') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="name"
                                   ...
                                   class="w-full mt-2 p-3 rounded-xl bg-white/5 border border-white/20 backdrop-blur-xl text-white placeholder-white/60
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                      ...
                                      class="w-full mt-2 p-3 rounded-xl bg-white/5 border border-white/20 backdrop-blur-xl text-white placeholder-white/60
                                             transition duration-300 hover:bg-white/20 focus:bg-white/30 focus:ring-2 focus:ring-blue-400">{{ old('description') }}</textarea>
