    ...
    <div class="flex-1 flex flex-col transition-all duration-300">
      ...
      <header 
        ...
        <div class="flex items-center gap-3">
          ...
          <h1 class="text-2xl font-bold text-white drop-shadow">Detail Jurusan</h1>
        </div>
      ...
      <main class="p-6 flex-1 mt-4">
        <div class="bg-white/30 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl p-8 max-w-2xl mx-auto text-white"
          ...
          <h2 class="text-3xl font-bold mb-8 text-center drop-shadow-md">🏫 Detail Jurusan</h2>
          ...
          <div class="relative pl-6 space-y-6">
            ...
            @php
              $fields = [
                ...
                'Kode Jurusan' => $department->code ?? '-',
                'Kepala Jurusan' => $department->headTeacher->name ?? '-',
                'Jumlah Kelas' => $department->classes->count() ?? 0,
