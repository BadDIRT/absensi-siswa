      ...
      <div class="flex-1 flex flex-col transition-all duration-300">
        ...
        <header 
          ...
          <div class="flex items-center gap-3">
            ...
            <h1 class="text-2xl font-bold text-white drop-shadow">Data Jurusan</h1>
          </div>
        ...
        <main class="p-6 space-y-8 flex-1 mt-4">
          <div class="bg-white/30 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl p-6 overflow-x-auto">
            <h2 class="text-xl font-bold text-white mb-4">Daftar Jurusan</h2>
            ...
            <table class="w-full text-white min-w-[800px] text-sm sm:text-base">
              ...
              <tbody>
                ...
                @empty
                <tr>
                  <td colspan="5" class="text-center py-4 text-white/80">Belum ada data jurusan.</td>
                </tr>
                @endforelse
              </tbody>
            </table>
